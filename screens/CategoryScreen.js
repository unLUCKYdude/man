...
const CategoryScreen = ({ route, navigation }) => {
    ...
    return <View style={{flex: 1, backgroundColor: "#fff"}}>
        <View style={{backgroundColor: "#136384", height: 60, flexDirection: "row", alignItems: "center"}}>
        ...
        <View style={{flexDirection: "row", padding: 16, alignItems: "center", borderBottomColor: "#136384", borderBottomWidth: 3}}>
            <Text style={{fontFamily: "OpenSansCondensed-Bold", fontSize: 24}}>Категория:</Text>
            <Text style={{
                fontFamily: "OpenSansCondensed-Bold",
                fontSize: 18,
                marginLeft: 16,
                backgroundColor: "#136384",
                color: "#fff",
